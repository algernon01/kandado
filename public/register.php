  ...
  <div class="auth-shell">
    <section class="auth-preview" aria-hidden="true">
      ...
      <footer class="preview-footer">
        <p>Set up in minutes, scale with confidence.</p>
      </footer>
    </section>

    <div class="auth-card register-container no-flare">
      <header class="header">
        <span class="brand-chip">Kandado</span>
        <h1 class="title">Get started</h1>
        <p class="subtitle">Fill out the details below to create an account.</p>
      </header>
